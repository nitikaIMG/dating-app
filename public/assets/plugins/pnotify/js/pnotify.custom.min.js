    ...
    var n,
        ...
        s = function (e, n) {
            ...
            if (
                ...
                e.match(t) || (e = "on" + e),
                    (s = document.createEventObject(n)),
                    this.fireEvent(e, s);
        },
        a = function (e, t, i) {
            ...
            var l = o(c),
                a = l.css("cursor");
            "auto" === a && "A" === c.tagName && (a = "pointer"),
                e.elem.css("cursor", "auto" !== a ? a : "default"),
                (n && n.get(0) == c) ||
                    (n &&
                        (s.call(n.get(0), "mouseleave", t.originalEvent),
                        s.call(n.get(0), "mouseout", t.originalEvent)),
                    s.call(c, "mouseenter", t.originalEvent),
                    s.call(c, "mouseover", t.originalEvent)),
                s.call(c, i, t.originalEvent),
                (n = l);
        };
    return (
            ...
            init: function (o, e) {
                ...
                o.elem.on({
                    ...
                    mousemove: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), a(o, e, "onmousemove"));
                    },
                    ...
                    click: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), a(o, e, "onclick"));
                    },
                    dblclick: function (e) {
                        t.options.nonblock &&
                            (e.stopPropagation(), a(o, e, "ondblclick"));
                    },
                });
            },
        }),
