     ...
     <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Relationship Types</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Basics</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Relationship Types</li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{route('relationship_type.create')}}">
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('relationship_type.index') }}",
          columns: [
...
<script>
    function  updatestatus(id){
        (new PNotify({
            ...
            url: '{{route('relationship_typestatus')}}',
            method: 'POST',
            data: { id: id },
    ...
    function  deleterecord(id){
        (new PNotify({
            ...
            $.ajax({
                ...
                url: '{{route("relationship_type.deleterecord")}}',
                data: {id:id},
                method: 'DELETE',
                success: function (response) {
                    if(response.status == 'success')
