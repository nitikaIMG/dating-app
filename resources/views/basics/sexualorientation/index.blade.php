     ...
     <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Sexual Orientation</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Basics</a></li>
                        <li class="breadcrumb-item active" aria-current="page">sexualorientation</li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{route('sexualorientation.create')}}">
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('sexualorientation.index') }}",
          columns: [
...
<script>
    function  updatestatus(id){
        (new PNotify({
            ...
            url: '{{route('sexualorientationstatus')}}',
            method: 'POST',
            data: { id: id },
    ...
    function  deleterecord(id){
        (new PNotify({
            ...
            $.ajax({
                ...
                url: '{{route("sexualorientation.deleterecord")}}',
                data: {id:id},
                method: 'DELETE',
                success: function (response) {
                    if(response.status == 'success')
