     ...
     <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Sleeping Habits</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Basics</a></li>
                        <li class="breadcrumb-item active" aria-current="page">sleeping habits</li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{route('sleepinghabit.create')}}">
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('sleepinghabit.index') }}",
          columns: [
    ...
    function  deleterecord(id){
        (new PNotify({
            ...
            $.ajax({
                ...
                url: '{{route("sleepinghabit.deleterecord")}}',
                data: {id:id},
                method: 'DELETE',
                success: function (response) {
                    if(response.status == 'success')
