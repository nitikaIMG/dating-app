                            ...
                            <table class="table table-striped table-bordered datatable" id="edit-btn">
                                <thead>
                                  <tr>
                                    ...
                                    <th>Name</th>
                                     <th>Price</th>
                                    <th>Unlimited Likes</th>
                                    <th>Priority Likes</th>
                                    <th>Free 1 Boost</th>
                                    <th>Status</th>
                                  </tr>
                                </thead>
    ...
    $(function () {
      var table = $('.datatable').DataTable({
          ...
          columns: [
              ...
              {data: 'unlimited_likes', name: 'unlimited_likes'},
              {data: 'priority_likes', name: 'priority_likes'},
              {data: 'free_boost_per_month_1', name: 'free_boost_per_month_1'},
